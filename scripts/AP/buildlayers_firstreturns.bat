...
REM CALL "%PROCESSINGHOME%\extract_metric" _first_returns_elevation_stats 49 FIRST_RETURNS_1st_cover_above%COVERHTLABEL%_%FILEIDENTIFIER% 1
REM CALL "%PROCESSINGHOME%\extract_metric" _first_returns_elevation_stats 50 FIRST_RETURNS_all_cover_above%COVERHTLABEL%_%FILEIDENTIFIER% 1
...
REM CALL "%PROCESSINGHOME%\extract_metric" _first_returns_elevation_stats 55 FIRST_RETURNS_1st_cover_above_mode_%FILEIDENTIFIER% 1
